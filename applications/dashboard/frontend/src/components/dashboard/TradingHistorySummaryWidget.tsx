...
export function TradingHistorySummaryWidget({ config: _config }: { config: WidgetConfig }) {
  const { data, isLoading } = useQuery({
    queryKey: ['portfolio-summary-all'],
    queryFn: () => portfolioTrackerService.getSummary({ from_date: undefined }),
